            ...
            try {
                ...
                case MenuAction::Attack: {
                    ...
                    if (wardenHP > 0) {
                        ...
                        std::cout << "The Warden hits for " << kWardenAttackDmg << "your HP -> " << std::max(playerHP, 0) << "\n";
                    }
                    break;
                case MenuAction::useItem: {
                        ...
                        if (wardenHP > 0 && playerHP > 0) {
                            ...
                            std::cout << "The Warden strikes while you fumble. Your HP -> " << std::max(playerHP, 0) << "\n";
                        }
                    }
                    break;
                case MenuAction::Inspect: {
                        std::cout << "Warden of the Foundationd. HP -> " << wardenHP << " \ " << kWardenAttackDmg << ". No visible weakness (free action).\n";
                        break;
                    }
